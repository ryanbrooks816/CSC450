...
import csc450lib.physics.Projectile;
...
public class test3 {
    public static void main(String[] args) {
        ...
        Projectile projectile = new Projectile(0, 10, 10, (float) Math.PI / 4, 0.85f);
        ...
        Projectile projectile2 = new Projectile(0, 10, 10, (float) Math.PI / 4, 0.85f);
        ...
        Projectile projectile3 = new Projectile(0, 10, 10, (float) Math.PI / 4, 0.85f);
        ...
        Projectile projectile4 = new Projectile(0, 10, 10, (float) Math.PI / 4, 0.85f);
