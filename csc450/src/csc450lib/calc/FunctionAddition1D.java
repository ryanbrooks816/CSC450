...
/**
 * Represents a one-dimensional function that is the addition of two other
 * one-dimensional functions.
 */
public class FunctionAddition1D extends Function1D {
    private Function1D f;
    private Function1D g;

    /**
     * Constructs a FunctionAddition1D object with the given functions.
     *
     * @param f The first function to be added.
     * @param g The second function to be added.
     */
    public FunctionAddition1D(Function1D f, Function1D g) {
        super();
        this.f = f;
        this.g = g;
    }
    ...
    /**
     * Constructs a FunctionAddition1D object with the given functions and
     ...
     */
    public FunctionAddition1D(Function1D f, Function1D g, float xmin, float xmax) {
        super(xmin, xmax);
        this.f = f;
        this.g = g;
    }
     ...
     */
    public FunctionAddition1D(Function1D f, Function1D g, DomainOfDefinition domain) {
        super(domain);
        this.f = f;
        this.g = g;
    }
     ...
     * @return The result of adding the values of the two functions at x.
     */
